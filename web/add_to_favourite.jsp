                        ...
                        <div class="card-body">
                            ...
                            <p><%= plantcare %></p>
                              <form action="DeleteFavItemServlet" method="post">
                                <input type="hidden" name="item_name" value="<%= plantName %>">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p><%= potType %></p>
                              <form action="DeleteFavItemServlet" method="post">
                                <input type="hidden" name="item_name" value="<%= potCategory %>">
                                <input type="hidden" name="item_type" value="pot">
                                <button type="submit" class="btn btn-danger">Delete</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p><%= description %></p>
                              <form action="DeleteFavItemServlet" method="post">
                                <input type="hidden" name="item_name" value="<%= soilName %>">
                                <input type="hidden" name="item_type" value="soil">
                                <button type="submit" class="btn btn-danger">Delete</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p><%= description %></p>
                              <form action="DeleteFavItemServlet" method="post">
                                <input type="hidden" name="item_name" value="<%= equipmentName %>">
